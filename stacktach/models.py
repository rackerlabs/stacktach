...
class RawDataImageMeta(models.Model):
    ...
    os_architecture = models.CharField(max_length=50, null=True, blank=True)
    os_distro = models.CharField(max_length=50, null=True, blank=True)
    os_version = models.CharField(max_length=50, null=True, blank=True)
    rax_options = models.CharField(max_length=50, null=True, blank=True)
